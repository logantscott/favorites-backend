    ...
    try {
        ...
        await Promise.all(
            favorites.map(favorite => {
                ...
                `,
                [favorite.name, favorite.url, favorite.image_url, favorite.external_id, favorite.min_players, favorite.max_players, favorite.min_playtime, favorite.max_playtime, 1]);
            })
        );
